...
export default function TrenInferiorPage() {
  ...
  const loadWorkouts = async () => {
    try {
      ...
      console.error('Error loading lower body workouts:', error);
      setWorkouts([]);
    } finally {
      setLoading(false);
    }
      ...
      <main className="pt-16 pb-20 px-4">
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center mb-6 mt-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Tren Inferior</h1>
              <p className="text-sm text-gray-600">Piernas, glúteos y pantorrillas</p>
            </div>
          </div>
          ...
          <div className="w-full h-32 mb-6 rounded-xl overflow-hidden">
            <img
              src="https://readdy.ai/api/search-image?query=Lower%20body%20workout%20gym%20equipment%20leg%20press%20squats%2C%20professional%20fitness%20photography%2C%20clean%20modern%20gym%2C%20strength%20training%20setup%2C%20leg%20muscle%20building%20equipment%2C%20fitness%20inspiration&width=400&height=200&seq=lower_body_hero&orientation=landscape"
              alt="Tren Inferior"
          ...
          {/* Quick Tips */}
          <div className="bg-gradient-to-r from-green-500 to-teal-600 rounded-xl p-4 text-white mt-6">
            <h3 className="font-semibold mb-2">🦵 Consejos para Tren Inferior</h3>
            <ul className="text-sm opacity-90 space-y-1">
              <li>• Mantén la espalda recta en sentadillas</li>
              <li>• Activa los glúteos en cada ejercicio</li>
              <li>• Controla el descenso y la subida</li>
              <li>• Estira después del entrenamiento</li>
            </ul>
          </div>
        </div>
      </main>
