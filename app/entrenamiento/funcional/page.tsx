...
export default function FuncionalPage() {
  ...
  const loadWorkouts = async () => {
    try {
      ...
      console.error('Error loading functional workouts:', error);
      setWorkouts([]);
    } finally {
      setLoading(false);
    }
      ...
      <main className="pt-16 pb-20 px-4">
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center mb-6 mt-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Funcional</h1>
              <p className="text-sm text-gray-600">Movimientos funcionales</p>
            </div>
          </div>
          ...
          <div className="w-full h-32 mb-6 rounded-xl overflow-hidden">
            <img
              src="https://readdy.ai/api/search-image?query=Functional%20training%20equipment%20kettlebells%20medicine%20balls%2C%20professional%20fitness%20photography%2C%20clean%20modern%20gym%2C%20functional%20movement%20setup%2C%20athletic%20training%20equipment%2C%20fitness%20inspiration&width=400&height=200&seq=functional_hero&orientation=landscape"
              alt="Funcional"
          ...
          <div className="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl p-4 text-white mt-6">
            <h3 className="font-semibold mb-2">⚡ Consejos para Funcional</h3>
            <ul className="text-sm opacity-90 space-y-1">
              <li>• Enfócate en la calidad del movimiento</li>
              <li>• Trabaja todo el cuerpo como una unidad</li>
              <li>• Incluye ejercicios multiplanares</li>
              <li>• Progresa gradualmente en complejidad</li>
            </ul>
          </div>
        </div>
      </main>
