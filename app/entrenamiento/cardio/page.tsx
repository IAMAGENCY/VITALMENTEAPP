      ...
      <main className="pt-16 pb-20 px-4">
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center mb-6 mt-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Cardio</h1>
              <p className="text-sm text-gray-600">Ejercicios cardiovasculares</p>
            </div>
          </div>
          ...
          <div className="w-full h-32 mb-6 rounded-xl overflow-hidden">
            <img
              src="https://readdy.ai/api/search-image?query=Cardio%20workout%20gym%20equipment%20treadmill%20cycling%2C%20professional%20fitness%20photography%2C%20clean%20modern%20gym%2C%20cardiovascular%20training%20setup%2C%20heart%20rate%20training%20equipment%2C%20fitness%20inspiration&width=400&height=200&seq=cardio_hero&orientation=landscape"
              alt="Cardio"
          ...
          {/* Quick Tips */}
          <div className="bg-gradient-to-r from-red-500 to-pink-600 rounded-xl p-4 text-white mt-6">
            <h3 className="font-semibold mb-2">❤️ Consejos para Cardio</h3>
            <ul className="text-sm opacity-90 space-y-1">
              <li>• Mantén una intensidad del 70-85% FCM</li>
              <li>• Respira profundamente durante el ejercicio</li>
              <li>• Empieza gradualmente y aumenta intensidad</li>
